...
public class VsoftOrganization {
    ...
    public static void main(String[] args) {
        ...
        Employee m1 = new Employee("Srinivas Ponna", "EM044","Manager");
        Employee d1 = new Employee("Manoj Garimella", "EM004","Developer");
        Employee d2 = new Employee("Ramarao", "EM005","Developer");
        ...
        Employee d4= new Employee("Praveen", "EM007","Developer");
        Employee[] mulesoftdv={m3,d3,d4};

        Employee m4 = new Employee("Ravi Babu", "EM058","Manager");
        Employee d5= new Employee("Hemanth", "EM008","Developer");
        Employee d6= new Employee("Naresh", "EM009","Developer");
        Employee[] awsdv={m4,d5,d6};

        Employee m7 = new Employee("Ravi Babu", "EM058","Manager");
        Employee d9= new Employee("Sravani", "EM066","Developer");
        Employee d10= new Employee("Lalitha", "EM055","Developer");
        Employee[] servicenowdv={m7,d9,d10};

        Employee m5 = new Employee("Srinivas Pabba", "EM065","Manager");
        Employee d7= new Employee("Preetham", "EM010","Developer");
        ...
        Employee hr2= new Employee("Ramchandra", "EM013", "HR");
        Employee hr3= new Employee("Sumitra", "EM014", "HR");
